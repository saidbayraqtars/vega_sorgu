  ...
  return (
    <div className="p-8 space-y-6">
      <div>
        ...
        <p className="text-dark-400 mt-1">Cari giriş/tahsilat (13) ve çıkış/ödeme (11) hareketleri</p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="rounded-xl bg-dark-800/60 border border-white/5 p-4"><p className="text-xs text-dark-400">Toplam Ödeme (Borç)</p><p className="text-lg font-bold text-red-400 mt-1">{formatTL(res.toplam.borc || 0)}</p></div>
            ...
            <tbody>
              {res.data.map((h, i) => (
                <tr key={i} className="border-t border-white/5 hover:bg-white/5">
                  ...
                  <td className="px-4 py-3 text-dark-300">{String(h.IZAHAT) === "13" ? "Tahsilat (Cari Giriş)" : String(h.IZAHAT) === "11" ? "Ödeme (Cari Çıkış)" : h.IZAHAT}</td>
